...
2. `generate_vfile.py` 실행 → `adder_n.v` 파일 생성. https://github.com/goeun-oh/Verilog-verification-automation-tool/blob/hotfix_v01/explain/adder_nbit.md
3. `generate_tb.py` 실행 → `adder_tb.v` 파일 생성. https://github.com/goeun-oh/Verilog-verification-automation-tool/blob/hotfix_v01/explain/adder_tb.md
